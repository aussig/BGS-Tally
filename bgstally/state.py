...
class State:
    ...
    def load(self):
        ...
        self.AutoTrackCarriers:tk.StringVar = tk.StringVar(value=config.get_str('BGST_AutoTrackCarriers', default=CheckStates.STATE_OFF))
    ...
    def save(self):
        ...
        config.set('BGST_AutoTrackCarriers', self.AutoTrackCarriers.get())
