...
from thirdparty.table2ascii import table2ascii, Alignment, TableStyle, PresetStyle
...
class ProgressWindow:
    ...
    def _get_comms(self, required:list[dict], delivered:list[dict]) -> list[Commodity]:
