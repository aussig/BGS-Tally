    ...
    return DotDict(
        {
            **theme_light_blue,
            ...
            "insert_columns_right_label": _("Insert columns right"), # LANG: Spreadsheet menu item
            ...
            # reverse labels
            "sort_cells_reverse_label": _("Sort Desc."), # LANG: Spreadsheet menu item
