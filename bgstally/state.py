...
class State:
    ...
    def load(self):
        ...
        self.FcSellingCommodities:tk.StringVar = tk.StringVar(value=config.get_str('FcSellingCommodities', default=CheckStates.STATE_ON))
        self.FcBuyingCommodities:tk.StringVar = tk.StringVar(value=config.get_str('FcBuyingCommodities', default=CheckStates.STATE_ON))
        self.FcSellingMaterials:tk.StringVar = tk.StringVar(value=config.get_str('FcSellingMaterials', default=CheckStates.STATE_ON))
        self.FcBuyingMaterials:tk.StringVar = tk.StringVar(value=config.get_str('FcBuyingMaterials', default=CheckStates.STATE_ON))
        self.FcCargo:tk.StringVar = tk.StringVar(value=config.get_str('FcCargo', default=CheckStates.STATE_ON))
        self.FcLocker:tk.StringVar = tk.StringVar(value=config.get_str('FcLocker', default=CheckStates.STATE_ON))
    ...
    def save(self):
        ...
        config.set('FcSellingCommodities', self.FcSellingCommodities.get())
        config.set('FcBuyingCommodities', self.FcBuyingCommodities.get())
        config.set('FcSellingMaterials', self.FcSellingMaterials.get())
        config.set('FcBuyingMaterials', self.FcBuyingMaterials.get())
        config.set('FcCargo', self.FcCargo.get())
        config.set('FcLocker', self.FcLocker.get())
