...
class WindowActivity:
    ...
    def _update_discord_field(self, DiscordText, activity: Activity):
        ...
        DiscordText.write(self.bgstally.formattermanager.get_default_formatter().get_text(activity, DiscordActivity.BOTH, True, lang=self.bgstally.state.discord_lang))
    ...
    def _post_to_discord(self, activity: Activity):
        ...
        if self.bgstally.state.DiscordPostStyle.get() == DiscordPostStyle.TEXT:
            if self.bgstally.state.DiscordActivity.get() != DiscordActivity.THARGOIDWAR:
                discord_text: str = self.bgstally.formattermanager.get_default_formatter().get_text(activity, DiscordActivity.BGS, True, lang=self.bgstally.state.discord_lang)
            ...
            if self.bgstally.state.DiscordActivity.get() != DiscordActivity.BGS:
                discord_text = self.bgstally.formattermanager.get_default_formatter().get_text(activity, DiscordActivity.THARGOIDWAR, True, lang=self.bgstally.state.discord_lang)
            ...
            if self.bgstally.state.DiscordActivity.get() != DiscordActivity.THARGOIDWAR:
                discord_fields: dict = self.bgstally.formattermanager.get_default_formatter().get_fields(activity, DiscordActivity.BGS, lang=self.bgstally.state.discord_lang)
            ...
            if self.bgstally.state.DiscordActivity.get() != DiscordActivity.BGS:
                discord_fields = self.bgstally.formattermanager.get_default_formatter().get_fields(activity, DiscordActivity.THARGOIDWAR, lang=self.bgstally.state.discord_lang)
    ...
    def _copy_to_clipboard(self, Form:tk.Frame, activity:Activity):
        ...
        Form.clipboard_append(self.bgstally.formattermanager.get_default_formatter().get_text(activity, DiscordActivity.BOTH, True, lang=self.bgstally.state.discord_lang))
        Form.update()
